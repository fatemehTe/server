...
const sampleTopicGrandSchema = mongoose.Schema({
...
const sampleTopicGrand = mongoose.model('sampleTopicGrand', sampleTopicGrandSchema)

export default sampleTopicGrand;